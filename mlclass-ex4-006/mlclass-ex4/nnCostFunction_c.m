...
for i = 1:m
    ...
    J = J + ((-y_matrix(i,:)) * log(a3)' - (1-y_matrix(i,:)) * log(1 - a3)')/m;
...
sum1 = Theta1 .^2;
sum1 = sum1(:, 2:end) * ones(input_layer_size, 1);
sum1 = sum1' * ones(hidden_layer_size, 1);
sum2 = Theta2 .^2;
sum2 = sum2(:, 2:end) * ones(hidden_layer_size,1);
sum2 = sum2' * ones(num_labels, 1);
